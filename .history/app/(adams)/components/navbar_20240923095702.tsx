            ...
            <div className="">
                ...
                <div className='flex flex-col gap-20'>
                    ...
                    <div className='flex gap-2'>
                        <Image src={images.linkedIn} alt='image' className='w-[20%] h-[20%]'  />
                        <Image src={images.dribble} alt='image' className='w-[20%] h-[20%]'  />
                        <Image src={images.behance} alt='image' className='w-[20%] h-[20%]'  />
                        <Image src={images.email} alt='image' className='w-[20%] h-[20%]'  />
                    </div>
