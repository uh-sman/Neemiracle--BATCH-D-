        ...
        <div className='w-full h-auto md:h-screen'>
            ...
            <div className="my-10 md:my-44">
                ...
                <div className='flex flex-col items-center gap-10 my-10 md:my-44 mx-8'>
                    <div>
                        <Image src={images.reachOut} alt='reach out image' className='w-[80%] max-w-[300px] h-auto' />
                    </div>
                    <div className='flex justify-center gap-10'>
                        <Image src={images.linkedIn} alt='LinkedIn' className='w-[10%] max-w-[50px] h-auto' />
                        <Image src={images.dribble} alt='Dribbble' className='w-[10%] max-w-[50px] h-auto' />
                        <Image src={images.behance} alt='Behance' className='w-[10%] max-w-[50px] h-auto' />
                        <Image src={images.email} alt='Email' className='w-[10%] max-w-[50px] h-auto' />
                    </div>
                    {/* <Text w="bold" size="5xl" className="text-black text-center">Want to reach out?</Text> */}
                </div>
            </div>
        </div>
    );
