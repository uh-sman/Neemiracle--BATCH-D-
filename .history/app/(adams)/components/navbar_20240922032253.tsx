        ...
        <div className='w-full h-screen'>
            ...
            <div className="">
                ...
                <div>
                    {menus.map((menu) => (
                        <div key={menu.id}>
                            <div className='grid grid-cols-3 p-6 cursor-pointer' onClick={() => setToggle(toggle === menu.id ? null : menu.id)}>
                            ...
                            {toggle === menu.id && (
                                <div className="p-4 bg-gray-100">
                                    ...
                                    <Text w="light" size="md">This is additional content for {menu.title}.</Text>
                                </div>
                            )}
                        </div>
                    ))}
