    ...
    return (
        <div className='w-full h-screen'>
            ...
            <div className="">
                ...
                <div className='px-8 grid grid-cols-2 my-56'>
                    <div className='flex'>
                ...
                <div className='flex flex-col gap-20 my-44 mx-8'>
                    <div>
                        <Image src={images.reachOut} alt='image' className='w-[35%] h-[35%]'/>
                    </div>
                    <div className='flex gap-[40px]'>
                        <Image src={images.linkedIn} alt='image' className='w-[7%] h-[7%]'  />
                        <Image src={images.dribble} alt='image' className='w-[7%] h-[7%]'  />
                        <Image src={images.behance} alt='image' className='w-[7%] h-[7%]'  />
                        <Image src={images.email} alt='image' className='w-[7%] h-[7%]'  />
                    </div>
