        ...
        <div className='w-full h-screen'>
            ...
            <div className="">
                ...
                <div className='flex flex-col gap-20'>
                    <div>
                        <Image src={images.reachOut} alt='image' className='w-[20px] h-[20px]'/>
                    </div>
                    <div className='flex gap-2'>
                        <Image src={images.linkedIn} alt='image'  />
                        <Image src={images.dribble} alt='image'  />
                        <Image src={images.behance} alt='image'  />
                        <Image src={images.email} alt='image'  />
                    </div>
