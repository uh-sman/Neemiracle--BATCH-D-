  ...
  return (
    ...
    <div className="">
        ...
        <div className='px-8'>
            ...
            <div className='flex'>
                <Text w="bold" size="2xl" className="text-black">I am a skilled product designer specializing in creating user-centered web and mobile application design across various industries, including fintech, logistic, medtech, edutech, and digital marketing.</Text>
