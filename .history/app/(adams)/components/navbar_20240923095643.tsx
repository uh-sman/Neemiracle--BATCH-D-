            ...
            <div className="">
                ...
                <div className='flex flex-col gap-20'>
                    ...
                    <div className='flex gap-2'>
                        <Image src={images.linkedIn} alt='image' className='w-[35%] h-[35%]'  />
                        <Image src={images.dribble} alt='image' className='w-[35%] h-[35%]'  />
                        <Image src={images.behance} alt='image' className='w-[35%] h-[35%]'  />
                        <Image src={images.email} alt='image' className='w-[35%] h-[35%]'  />
                    </div>
