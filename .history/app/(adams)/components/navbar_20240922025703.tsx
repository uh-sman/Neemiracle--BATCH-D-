  ...
  return (
    ...
    <div className="">
        ...
        <div className='px-8 grid grid-cols-2'>
            ...
            <div className='flex'>
                <Text w="bold" size="lg" className="text-black">I am a skilled product designer specializing in creating user-centered web and mobile application design across various industries, including fintech, logistic, medtech, edutech, and digital marketing.</Text>
        ...
        <div>
            {
                menus.map((menu) => {
                    return(
                        <div key={menu.id} className='grid grid-cols-3 p-6' onClick={(e) => setToggle(e.target.value)}>
