        ...
        <div className='w-full h-screen'>
            ...
            <div className="">
                ...
                <div>
                    ...
                    <div className='flex'>
                        <Image src={images.linkedIn} alt='image' className='w-[150px] h-[150px]' />
                        <Image src={images.dribble} alt='image' className='w-[150px] h-[150px]' />
                        <Image src={images.behance} alt='image' className='w-[150px] h-[150px]' />
                        <Image src={images.email} alt='image' className='w-[150px] h-[150px]' />
                    </div>
