    ...
    <div>
       <div className='flex flex-col sm:flex-col items-center justify-center gap-6 sm:gap-10 mt-[200px]'>
                    <div className='text-center sm:text-left relative'>
                        <Text w="bold" size="5xl" className="text-black text-3xl absolute -left-[300px] text-nowrap">
                            Learn Lane
                        </Text>
                        <Text w="bold" size="5xl" className="text-black text-3xl absolute -left-[20px] top-[20px]">
                            Learn Lane
                        </Text>
                    </div>
                    <div>
