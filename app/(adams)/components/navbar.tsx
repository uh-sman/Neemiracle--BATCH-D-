            ...
            <div className="my-16 sm:my-44">
                {/* <div className='flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10'>
                 ...
                 <div className='mt-[40px] flex justify-center'>
                        <Image src={images.frame5} alt='study image' className='' />
                    </div>
                ...
                <div className='mt-[40px] flex justify-center'>
                        <Image src={images.frame4} alt='study image' className='' />
                    </div>
                <div className='my-16 sm:my-44'>
                    {menus.map((menu) => (
                        <div key={menu.id} onClick={() => router.push(menu.href!)}>
                            <div className='grid grid-cols-1 sm:grid-cols-4 p-4 sm:p-6 border-b border-black/90 cursor-pointer place-items-center' onClick={() => setToggle(toggle === menu.id ? null : menu.id)}>
                                ...
                                <Text w="bold" size="lg" className="text-black hidden sm:block">{menu.title}</Text>
                                <Image src={images.navigationArrow} alt='arrow'/> 
                            </div>
